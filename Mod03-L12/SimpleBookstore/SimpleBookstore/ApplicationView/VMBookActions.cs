...
using SimpleBookstore.Utilities;
using System;
...
namespace SimpleBookstore.ApplicationView
{
    // View Model Book Actions
    public class VMBookActions  // : Book
    {
        //public void Import(Book x)
        //{
        //  this.Id = x.Id;
        //  this.Title = x.Title;
        ...
        //  x.Id = this.Id; 
        //  x.Title = this.Title;  
        //  x.Authors = this.Authors;  
        //  x.Publisher = this.Publisher;  
        //  x.Year = this.Year;
        ...
        //=============================================================
        // Common
        // SelectId is used by menu handled on actions
        // Show
        // Edit 
        // Delete
        //-------------------------------------------------------------
        ...
        //============================================================
        // class VMBookActions implements fixed actions set for Book
        // Create
        // Show
        // Showlist
        // Edit
